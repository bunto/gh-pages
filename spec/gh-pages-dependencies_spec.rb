...
describe(GitHubPages::Dependencies) do
  CORE_DEPENDENCIES = %w(
    bunto kramdown liquid rouge bunto-sass-converter
    gh-pages-health-check listen
  ).freeze
  ...
  it "exposes relevant versions of dependencies, self and Ruby" do
    ...
    expect(described_class.versions).to include("gh-pages")
  end

  context "bunto core dependencies" do
